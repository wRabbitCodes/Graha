...
export function PlanetChatbox() {
  ...
  return (
  <div className="w-full h-full flex flex-col text-white font-mono bg-black/30 backdrop-blur-md border border-gray-700 rounded-xl overflow-hidden relative">
    {/* Chat Display Area */}
    <div
      className="absolute top-0 left-0 right-0 bottom-24 overflow-y-auto px-4 py-3 space-y-2 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent"
      ref={containerRef}
    >
      {msgs.length === 0 ? (
        <div className="text-gray-400 text-center mt-10">
          Ask me about the planets...
        </div>
      ) : (
        msgs.map((m, i) => (
          <motion.div
    ...
    <div className="absolute bottom-0 left-0 right-0 border-t border-gray-600 px-4 py-3 bg-black/60">
